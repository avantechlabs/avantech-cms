...
2. Interview me relentlessly about every aspect of the user journey/experience until we reach a shared understanding. Walk down each branch of their decistion tree, resolving dependencies between decisions one-by-one. For each question, provide your recommended answer.

Ask the questions one at a time. Ask user if html should be used as prototype
...
- The backend/API seam for rules, data access, and security behavior
- The frontend/UI seam for user-visible stories, navigation, role states, empty states, and denied states
- Which stories are backend-only, if any
- Which stories require both API tests and UI tests or manual smoke tests
